...
export const products: Product[] = [
  ...
  },
  {
    ...
    care: "Cold machine wash inside out. Dry flat in shade. Do not tumble dry.",
    colors: [
      { name: "White", hex: "#e2e2e2", image: "/products/hoodie/white.jpg" },
      { name: "Grey", hex: "#898989", image: "/products/hoodie/grey.jpg" },
      { name: "Royal Blue", hex: "#1651b4", image: "/products/hoodie/blue.jpg" },
      { name: "Green", hex: "#216f1b", image: "/products/hoodie/green.jpg" },
      { name: "Mustard", hex: "#b9851a", image: "/products/hoodie/mustard.jpg" },
      { name: "Orange", hex: "#e26443", image: "/products/hoodie/orange.jpg" },
      { name: "Red", hex: "#ad0a25", image: "/products/hoodie/red.jpg" },
